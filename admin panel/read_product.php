...
<title>Cheers Bar - Admin Add Products page</title>
...
<div class="status" style="color: <?php if($fetch_products['status']=='active'){echo "green";}else{echo "coral";} ?>"><?= $fetch_products['status']; ?></div>
...
<?php
    ...
    echo '
    <div class="empty">
    <p>no product added yet! <br> <a href="add_products.php" class="btn" style="margin-top:1.5rem; line-hight:2">add products</a></p>                        
    </div>
    ';
    }
?>   
